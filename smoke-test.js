...
ok('Transcript has multiple fallback engines', ['openai/whisper','Dauzy/whisper-webui','dbredvick/whisper-webui','hf-audio/whisper-large-v3'].every(x=>app.includes(x)));
